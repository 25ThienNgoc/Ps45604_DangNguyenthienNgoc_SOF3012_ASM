...
<%@ page import="com.poly.util.PageConstants" %>

<header class="admin-header">
  <nav class="navbar">
    <div class="navbar-brand">
      <a
        href="${pageContext.request.contextPath}<%= PageConstants.URL_ADMIN_HOME %>"
        class="logo"
    ...
    <ul class="nav-links">
      ...
      <li>
        <a
          href="${pageContext.request.contextPath}<%= PageConstants.URL_ADMIN_REPORTS %>"
          >REPORTS</a
        >
      </li>
