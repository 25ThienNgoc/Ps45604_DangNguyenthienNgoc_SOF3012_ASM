...
<body>
    ...
    <div class="container account-page">
        <form action="${pageContext.request.contextPath}${LOGIN_URL}" method="post">
            <div class="account-box">
                ...
                <div class="form-group">
                    ...
                    <%-- Hiển thị username/password đã nhớ (từ cookie) --%>
                    <input type="text" id="username" name="username" required value="${cookie.user.value}" placeholder="Tên đăng nhập" />
                </div>
                
                <div class="form-group">
                    <label for="password">PASSWORD?</label>
                    <input type="password" id="password" name="password" required value="${cookie.pass.value}" placeholder="Mật khẩu" />
                </div>
                
                <div class="form-group remember-me">
                    <input type="checkbox" id="remember" name="remember" ${not empty cookie.user ? 'checked' : ''}/>
                    <label for="remember">REMEMBER ME?</label>
                </div>

                <div class="form-actions">
                    <%-- [Send].Click: Xử lý đăng nhập --%>
                    <button type="submit" class="btn btn-login">Login</button>
                </div>
                
                <div class="link-actions">
                    <a href="${pageContext.request.contextPath}${FORGOT_PASSWORD_URL}">Quên mật khẩu?</a>
                    <a href="${pageContext.request.contextPath}${REGISTRATION_URL}">Đăng ký tài khoản mới</a>
                </div>
            </div>
        </form>
    </div>
